...
<body class="body">
	...
	<div class="my-btn-box">
		<span class="fl">
			<div class="layui-btn-group">
				...
				<@shiro.hasPermission name="sys:role:enable">  
				...
				<@shiro.hasPermission name="sys:role:allocate">  
		...
		<span class="fr">
			<div class="layui-form-pane">
				<div class="layui-input-inline">
					<input type="text" autocomplete="off" name="name" id="name" placeholder="请输入角色名称"  class="layui-input"/>
				</div>
	...
	<script type="text/javascript" src="${base}/static/js/app/role/list.js"></script>
</body>
</html>